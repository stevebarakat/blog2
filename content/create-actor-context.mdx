...
abstract: In this lesson, we'll look at a more convienent way of accessing and interacting with context. To do this we'll use a helper function called createActorContext from the @xstate/react package.
publishedOn: 3
---
